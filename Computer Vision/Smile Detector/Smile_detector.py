...
def faceDetector(gray_image, original_frame, face_cascade, eye_cascade, smile_cascade):
    ...
    for(x, y, w, h) in faces:
        ...
        smiles = smile_cascade.detectMultiScale(roi_gray, 2, 15)
        for (sx, sy, sw, sh) in smiles:
            cv.rectangle(roi_color, (sx, sy),(sx+sw, sy+sh), (255, 0, 0), 1)
...
def main():
    ...
    while True:
        ...
        detection = faceDetector(
            gray_image, frame, face_cascade, eye_cascade, smile_cascade)
